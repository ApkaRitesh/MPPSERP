...
<b>Step-3 :</b> Placement <br>
   ...
   <br><br>
   make sure your directory setup is like : <i>C:\xampp\htdocs\MPPSERP\ </i> : and index.php file is available on the that location

<b>Step-4 :</b> Run the application <br>
   <b> visit on the url : <i>http://localhost/MPPSERP</i> </b>
