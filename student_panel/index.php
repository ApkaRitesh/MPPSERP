    ...
    <header>
        ...
        <a href="index.php">
            ...
            <a href="workspace.php">
                <span class="material-icons-sharp", onclick="discription" ></span>
                <h3>Workspace</h3>
            </a>
            <a href="password.php">
                <span class="material-icons-sharp" ,onclick="password" </span>
        ...
        <div class="theme-toggler">
            <span class="material-icons-sharp active" ,onclick="light_mode"></span>
            <span class="material-icons-sharp" ,onclick="dark_mode"></span>
        </div>
